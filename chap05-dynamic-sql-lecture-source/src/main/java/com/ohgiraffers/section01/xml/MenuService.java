...
public class MenuService {
    ...
    public void seletMenuByPrice(int price) {

        SqlSession sqlSession = getSqlSession();

        mapper = sqlSession.getMapper(DynamicSqlMapper.class);

        // price를 받아온 것을 Map 형태로 변환

        /*
        * 동적쿼리를 사용할 때 조건문의 값을 비교해야 하는데, 기본 자료형으로는 비교가 안 된다.
        * 그래서 hashMap의 key 혹은 dto의 getter를 이용해서 값을 비교한다.
        * */
