...
public class Application {
    ...
    private static void ifSubMenu() {
        ...
        do {
            ...
            System.out.println("1. 원하는 금액대에 적합한 메뉴 추천 목록 보여주기");
            ...
            switch (no) {
                case 1:
                    menuService.seletMenuByPrice(inputPrice());
                    break;
                case 2:
    ...
    private static void chooseSubMenu() {
        ...
        MenuService menuService = new MenuService();
        do {
            System.out.println("======== choose(when, otherwise) 서브 메뉴 ========");
    ...
    private static List<Integer> createRandomMenuCodeList() {
        ...
        // 중복 안 되게 하려고 set에 담고 그 다음에 list로 변환 한 것임.
    ...
    private static Map<String, Object> inputSearchCriteriaMap() {
        ...
        if ("category".equals(condition)) {
            ...
            criteria.put("nameValue", nameValue);
            criteria.put("categoryValuse", categoryValue);
